...
This model does not opimize the droop coefficients of the generators, hence it is called \textit{Preventive Security Constrained Optimal Powerflow with fixed droop coefficients}.
